export default function FireflyPhaseOffsetDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox={`0 0 ${w} ${h}`} className="w-full max-w-lg mx-auto" role="img" aria-label="Five LEDs with different phase offsets on sine waves, each glowing at its own time">
