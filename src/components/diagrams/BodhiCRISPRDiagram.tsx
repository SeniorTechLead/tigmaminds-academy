  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 570 400" className="w-full max-w-lg mx-auto" role="img" aria-label="CRISPR gene editing and cloning ethics overview">
        <rect width="570" height="400" rx="12" className="fill-slate-900" />
        ...
        <rect x="20" y="50" width="165" height="175" rx="8" className="fill-slate-800" />
        ...
        <text x="102" y="145" textAnchor="middle" className="fill-slate-400" fontSize="8">Cells are totipotent</text>
        <text x="102" y="158" textAnchor="middle" className="fill-slate-400" fontSize="8">Any cell can become</text>
        <text x="102" y="170" textAnchor="middle" className="fill-slate-400" fontSize="8">a whole new plant</text>
        <text x="102" y="190" textAnchor="middle" className="fill-slate-500" fontSize="8">Done for 1000s of years</text>
        <text x="102" y="205" textAnchor="middle" className="fill-slate-500" fontSize="8">Bananas, grapes, roses</text>
        <rect x="30" y="213" width="145" height="5" rx="2" className="fill-green-500" />

        {/* Column 2: Animal Cloning */}
        <rect x="200" y="50" width="165" height="175" rx="8" className="fill-slate-800" />
        ...
        <text x="282" y="145" textAnchor="middle" className="fill-slate-400" fontSize="8">Cells are specialized</text>
        <text x="282" y="158" textAnchor="middle" className="fill-slate-400" fontSize="8">Must reprogram nucleus</text>
        <text x="282" y="170" textAnchor="middle" className="fill-slate-400" fontSize="8">High failure rate</text>
        <text x="282" y="190" textAnchor="middle" className="fill-slate-500" fontSize="8">Dolly the Sheep (1996)</text>
        <text x="282" y="205" textAnchor="middle" className="fill-slate-500" fontSize="8">277 tries for 1 success</text>
        <rect x="210" y="213" width="145" height="5" rx="2" className="fill-amber-500" />

        {/* Column 3: CRISPR */}
        <rect x="380" y="50" width="165" height="175" rx="8" className="fill-slate-800" />
        ...
        <text x="462" y="145" textAnchor="middle" className="fill-slate-400" fontSize="8">Find a specific gene</text>
        <text x="462" y="158" textAnchor="middle" className="fill-slate-400" fontSize="8">Cut it out or replace it</text>
        <text x="462" y="170" textAnchor="middle" className="fill-slate-400" fontSize="8">Like find-and-replace</text>
        <text x="462" y="190" textAnchor="middle" className="fill-slate-500" fontSize="8">2012: Doudna & Charpentier</text>
        <text x="462" y="205" textAnchor="middle" className="fill-slate-500" fontSize="8">Nobel Prize 2020</text>
        <rect x="390" y="213" width="145" height="5" rx="2" className="fill-violet-500" />

        {/* CRISPR mechanism */}
        <text x="285" y="248" textAnchor="middle" className="fill-slate-300" fontSize="11" fontWeight="bold">How CRISPR Works</text>
        ...
        <text x="270" y="237" textAnchor="middle" className="fill-slate-500" fontSize="7">"find this sequence"</text>
        ...
        <rect x="80" y="340" width="140" height="22" rx="4" className="fill-slate-800" />
        <text x="150" y="355" textAnchor="middle" className="fill-teal-300" fontSize="9">Delete a harmful gene</text>

        <rect x="330" y="340" width="140" height="22" rx="4" className="fill-slate-800" />
