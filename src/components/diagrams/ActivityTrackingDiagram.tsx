  ...
  return (
    <div className="w-full max-w-lg mx-auto my-4">
      ...
      >
        ...
        <text x="495" y="90" textAnchor="middle" fontSize="10" className="fill-gray-300">
        ...
        {[
          ...
          <g key={i}>
            ...
            {t.tip.split('\n').map((line, j) => (
              <text key={j} x={t.x} y={282 + j * 12} textAnchor="middle" fontSize="9" className="fill-gray-400">{line}</text>
            ))}
          </g>
        ))}
        ...
        <text x="300" y="350" textAnchor="middle" fontSize="10" className="fill-gray-300">
          Your estimate will not be perfect. Real wildlife scientists face the same challenges:
        </text>
        <text x="300" y="368" textAnchor="middle" fontSize="10" className="fill-gray-400">
