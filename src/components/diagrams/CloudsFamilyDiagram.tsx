    ...
    <div className="w-full max-w-2xl mx-auto my-4">
      ...
      >
        ...
        {[
          ...
          <g key={t.label}>
            <line x1="70" y1={t.y} x2={w - 20} y2={t.y} className="stroke-gray-300 dark:stroke-slate-600" strokeWidth="0.5" strokeDasharray="4 4" />
            <text x="65" y={t.y + 4} textAnchor="end" fontSize="10" className="fill-gray-500 dark:fill-slate-400">
              {t.label}
            </text>
          </g>
        ))}
        ...
        <g>
          ...
          <rect x="290" y="50" width="200" height="42" rx="4" className="fill-gray-100 dark:fill-slate-800" fillOpacity="0.7" />
          <text x="300" y="66" fontSize="13" fontWeight="700" fill="#e0e7ff">Cirrus</text>
          <text x="300" y="80" fontSize="10" className="fill-gray-600 dark:fill-slate-300">{clouds[0].desc}</text>
        ...
        <g>
          ...
          <ellipse cx="140" cy="190" rx="30" ry="18" className="fill-gray-900 dark:fill-slate-50" fillOpacity="0.85" />
          <ellipse cx="175" cy="192" rx="28" ry="16" className="fill-gray-900 dark:fill-slate-50" fillOpacity="0.8" />
          <ellipse cx="158" cy="182" rx="22" ry="14" fill="#ffffff" fillOpacity="0.9" />
          <rect x="290" y="175" width="200" height="42" rx="4" className="fill-gray-100 dark:fill-slate-800" fillOpacity="0.7" />
          <text x="300" y="191" fontSize="13" fontWeight="700" fill="#f1f5f9">Cumulus</text>
          <text x="300" y="205" fontSize="10" className="fill-gray-600 dark:fill-slate-300">{clouds[1].desc}</text>
        ...
        <g>
          ...
          <rect x="100" y="316" width="160" height="12" rx="6" className="fill-gray-400 dark:fill-slate-500" fillOpacity="0.5" />
          <rect x="290" y="303" width="200" height="42" rx="4" className="fill-gray-100 dark:fill-slate-800" fillOpacity="0.7" />
          <text x="300" y="319" fontSize="13" fontWeight="700" className="fill-gray-500 dark:fill-slate-400">Stratus</text>
          <text x="300" y="333" fontSize="10" className="fill-gray-600 dark:fill-slate-300">{clouds[2].desc}</text>
        ...
        <g>
          ...
          {/* Dark base */}
          <rect x="80" y="370" width="120" height="60" rx="8" className="fill-gray-100 dark:fill-slate-800" fillOpacity="0.9" />
          {/* Tower body */}
          ...
          <ellipse cx="140" cy="100" rx="50" ry="15" className="fill-gray-400 dark:fill-slate-500" fillOpacity="0.7" />
          {/* Lightning bolt */}
          ...
          <rect x="290" y="390" width="200" height="42" rx="4" className="fill-gray-100 dark:fill-slate-800" fillOpacity="0.7" />
          <text x="300" y="406" fontSize="13" fontWeight="700" className="fill-gray-400 dark:fill-slate-500">Cumulonimbus</text>
          <text x="300" y="420" fontSize="10" className="fill-gray-600 dark:fill-slate-300">{clouds[3].desc}</text>
        ...
        {/* Bottom note */}
        <text x={w / 2} y={h - 10} textAnchor="middle" fontSize="10" className="fill-gray-500 dark:fill-slate-400">
