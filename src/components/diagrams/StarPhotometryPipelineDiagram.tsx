export default function StarPhotometryPipelineDiagram() {
  ...
  return (
    <svg viewBox="0 0 546 308" className="w-full max-w-2xl mx-auto my-4" role="img" aria-label="Photometry data pipeline from raw CCD image to calibrated magnitude">
