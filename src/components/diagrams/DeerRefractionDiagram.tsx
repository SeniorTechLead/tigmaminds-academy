  ...
  return (
    <div className="bg-gray-900 rounded-xl p-4 my-4">
      ...
      <svg viewBox="0 0 640 340" className="w-full max-w-2xl mx-auto">
        ...
        <text x="40" y="73" fontSize="10" className="fill-gray-500 dark:fill-gray-500">n = 1.00</text>
        ...
        <text x="40" y="173" fontSize="10" className="fill-gray-500 dark:fill-gray-500">n = 1.33</text>
        ...
        <text x="168" y="68" fontSize="10" className="fill-gray-500 dark:fill-gray-500">normal</text>

        {/* Incident ray */}
        <line x1="90" y1="55" x2="160" y2="140" stroke="white" strokeWidth={2.5} opacity={0.85} />
        <polygon points="90,55 98,63 86,65" className="fill-gray-900 dark:fill-white" opacity={0.85} />
        ...
        <text x="130" y="118" fontSize="10" className="fill-gray-900 dark:fill-white" opacity={0.7}>θ₁</text>
        ...
        <text x="480" y="24" textAnchor="middle" fontSize="12" fontWeight="700" className="fill-gray-900 dark:fill-white">
        ...
        <text x="480" y="180" textAnchor="middle" fontSize="10" className="fill-gray-500 dark:fill-gray-400">Glass</text>
        <text x="480" y="193" textAnchor="middle" fontSize="10" className="fill-gray-500 dark:fill-gray-500">n = 1.52</text>

        {/* White light in */}
        <line x1="340" y1="140" x2="445" y2="140" stroke="white" strokeWidth={3} opacity={0.7} />
        <text x="360" y="132" fontSize="10" className="fill-gray-900 dark:fill-white">White light</text>
        ...
        <text x="485" y="278" textAnchor="middle" fontSize="10" className="fill-gray-400 dark:fill-gray-400">
          Different wavelengths bend by different amounts.
        </text>
        <text x="485" y="293" textAnchor="middle" fontSize="10" className="fill-gray-400 dark:fill-gray-400">
