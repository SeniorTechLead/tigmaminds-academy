...
export default function LEDBlinkDiagram() {
  ...
  return (
    <div className="w-full bg-gray-900 rounded-xl p-6 text-white font-mono select-none">
      <h3 className="text-center text-lg font-bold text-green-400 mb-4">
      ...
      <div className="flex items-center justify-center gap-4 mb-6">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[9px] text-yellow-300">Pin 2</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[9px] text-gray-400">220Ω</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          />
          <span className={`text-sm font-bold ${ledOn ? 'text-green-400' : 'text-gray-500'}`}>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[9px] text-gray-400">→ GND</span>
        </div>
      </div>
      ...
      {powered && (
        <div className="mb-4">
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div
              className={`h-2 rounded-full transition-all duration-50 ${ledOn ? 'bg-green-500' : 'bg-gray-500'}`}
      ...
      <div className="flex flex-col items-center gap-4 mb-6">
        ...
        <div className="w-full max-w-xs">
          <label className="text-sm text-gray-300 block mb-1 text-center">
            Blink Speed: <span className="text-yellow-400 font-bold">{delay}ms</span>
          </label>
          <input
            type="range"
            min={200}
...
void loop() {
  ...
  delay(${delay});            // wait ${delay}ms
      ...
      <div className="mt-4 bg-gray-800 rounded-lg p-3 text-sm text-gray-300 leading-relaxed">
        ...
        <p><code className="text-green-400">digitalWrite(2, HIGH)</code> = send power to pin 2 → LED turns <span className="text-green-400 font-bold">ON</span></p>
        <p><code className="text-green-400">digitalWrite(2, LOW)</code> = cut power to pin 2 → LED turns <span className="text-red-400 font-bold">OFF</span></p>
        <p><code className="text-green-400">delay({delay})</code> = wait {delay} milliseconds before the next step</p>
      </div>
    </div>
  );
}
