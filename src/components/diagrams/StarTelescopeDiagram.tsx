export default function StarTelescopeDiagram() {
  ...
  return (
    <svg viewBox="0 0 546 340" className="w-full max-w-2xl mx-auto my-4" role="img" aria-label="Telescope comparison showing bigger aperture reveals fainter stars">
