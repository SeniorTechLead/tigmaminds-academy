...
export default function PhaseChangeDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 546 330" className="w-full max-w-2xl mx-auto" role="img" aria-label="Phase change diagram showing temperature plateaus during melting and boiling">
        {/* Y-axis */}
