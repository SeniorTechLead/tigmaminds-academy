export default function BanyanMonitoringDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 585 453" className="w-full max-w-2xl mx-auto" role="img" aria-label="Tree monitoring system showing sensors like dendrometers and sap flow meters, data logging, and satellite comparison">
        ...
        <text x="250" y="44" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="10">From manual measurement to automated monitoring</text>
        ...
        <text x="212" y="203" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="7">Measures growth ± 0.01mm</text>
        ...
        <text x="39" y="250" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="7">Litres / hour</text>
        ...
        <text x="130" y="73" className="fill-gray-500 dark:fill-slate-400" fontSize="7">Temp, humidity, wind, rain</text>
        ...
        <text x="50" y="356" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="7">probe at 3 depths</text>

        {/* === CENTER: Data Logger === */}
        <rect x="185" y="100" width="80" height="50" rx="6" className="fill-slate-700" />
        <rect x="190" y="105" width="70" height="30" rx="3" className="fill-gray-100 dark:fill-slate-800" />
        {/* Screen lines */}
        {[112, 118, 124].map((y, i) => (
          <line key={i} x1="195" y1={y} x2={230 - i * 5} y2={y} className="stroke-green-400" strokeWidth="1" opacity="0.6" />
        ))}
        <text x="225" y="145" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="8" fontWeight="bold">Data Logger</text>
        <text x="225" y="157" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="7">records every 15 min</text>
        ...
        <text x="350" y="115" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="8" fontWeight="bold">Cloud</text>
        <text x="350" y="128" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="7">Storage + API</text>
        ...
        <rect x="305" y="170" width="90" height="40" rx="3" className="fill-gray-100 dark:fill-slate-800" />
        {/* Mini chart */}
        ...
        <text x="455" y="213" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="7">NDVI, canopy</text>
        <text x="455" y="222" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="7">from above</text>

        {/* === BOTTOM: Evolution timeline === */}
        <rect x="30" y="365" width="440" height="45" rx="8" className="fill-gray-100 dark:fill-slate-800" />
        ...
        <text x="80" y="407" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="6">tape + notebook</text>
        ...
        <text x="180" y="407" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="6">continuous data</text>
        ...
        <text x="280" y="407" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="6">wireless real-time</text>
        ...
        <text x="380" y="407" textAnchor="middle" className="fill-gray-400 dark:fill-slate-500" fontSize="6">global forest watch</text>
