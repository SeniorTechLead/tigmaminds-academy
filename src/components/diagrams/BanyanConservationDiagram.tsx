  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 538 455" className="w-full max-w-lg mx-auto" role="img" aria-label="Conservation value of old trees as carbon stores, biodiversity hotspots, and cultural heritage with cost-benefit comparison">
        ...
        <text x="250" y="44" textAnchor="middle" className="fill-slate-400" fontSize="10">Why preservation outweighs removal</text>
        ...
        <text x="92" y="135" textAnchor="middle" className="fill-slate-300" fontSize="8">40 tonnes C stored</text>
        <text x="92" y="148" textAnchor="middle" className="fill-slate-300" fontSize="8">= 150 tonnes CO₂</text>
        <text x="92" y="161" textAnchor="middle" className="fill-slate-300" fontSize="8">kept from atmosphere</text>
        ...
        <text x="92" y="207" textAnchor="middle" className="fill-slate-500" fontSize="7">(500 years to regrow)</text>
        ...
        <text x="250" y="135" textAnchor="middle" className="fill-slate-300" fontSize="8">100+ species depend</text>
        <text x="250" y="148" textAnchor="middle" className="fill-slate-300" fontSize="8">on a single old tree</text>
        <text x="250" y="161" textAnchor="middle" className="fill-slate-300" fontSize="8">Cavities, epiphytes,</text>
        <text x="250" y="174" textAnchor="middle" className="fill-slate-300" fontSize="8">microhabitats</text>
        <text x="250" y="193" textAnchor="middle" className="fill-green-400" fontSize="8" fontWeight="bold">Old trees are hotspots</text>
        <text x="250" y="207" textAnchor="middle" className="fill-slate-500" fontSize="7">(young trees lack these)</text>
        ...
        <text x="408" y="135" textAnchor="middle" className="fill-slate-300" fontSize="8">Sacred groves, village</text>
        <text x="408" y="148" textAnchor="middle" className="fill-slate-300" fontSize="8">gathering places</text>
        <text x="408" y="161" textAnchor="middle" className="fill-slate-300" fontSize="8">Living monuments</text>
        <text x="408" y="174" textAnchor="middle" className="fill-slate-300" fontSize="8">connecting generations</text>
        <text x="408" y="193" textAnchor="middle" className="fill-amber-400" fontSize="8" fontWeight="bold">Cannot be replanted</text>
        <text x="408" y="207" textAnchor="middle" className="fill-slate-500" fontSize="7">(history is embedded)</text>
        ...
        <text x="135" y="358" textAnchor="middle" className="fill-slate-400" fontSize="8">- Opportunity cost of land</text>
        ...
        <text x="365" y="325" textAnchor="middle" className="fill-slate-500" fontSize="8">- 150 tonnes CO₂ released</text>
        <text x="365" y="340" textAnchor="middle" className="fill-slate-500" fontSize="8">- 100+ species displaced</text>
        <text x="365" y="358" textAnchor="middle" className="fill-slate-500" fontSize="8">- 500 years to replace</text>
