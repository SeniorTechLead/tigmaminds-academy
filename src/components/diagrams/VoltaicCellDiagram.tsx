export default function VoltaicCellDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 525 343" className="w-full max-w-2xl mx-auto" role="img" aria-label="Voltaic cell diagram with zinc anode, copper cathode, salt bridge, and electron flow">
