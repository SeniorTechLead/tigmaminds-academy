        ...
        {species.map((sp, i) => {
          ...
          return (
            <g key={i} transform={`translate(${xOff}, 60)`}>
              ...
              {/* Region */}
              <text x="50" y={baseY + 34} textAnchor="middle" fontSize="7" className="fill-slate-400">{sp.region}</text>
              {/* Status badge */}
              ...
              {/* Detail */}
              <text x="50" y={baseY + 70} textAnchor="middle" fontSize="7" className="fill-slate-400">{sp.detail}</text>
