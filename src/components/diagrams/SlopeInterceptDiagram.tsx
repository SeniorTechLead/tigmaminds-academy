export default function SlopeInterceptDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 420 395" className="w-full max-w-xl mx-auto" role="img" aria-label="Slope intercept diagram with three lines showing positive, zero, and negative slopes">
