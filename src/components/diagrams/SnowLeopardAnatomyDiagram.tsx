    ...
    <div className="w-full max-w-2xl mx-auto my-4">
      ...
      >
        ...
        <g transform="translate(300, 260)">
          ...
          {/* Body */}
          <ellipse cx="0" cy="0" rx="75" ry="32" className="fill-gray-500 dark:fill-gray-400" />
          ...
          {/* Hind legs */}
          <rect x="-45" y="25" width="14" height="35" rx="5" className="fill-gray-500 dark:fill-gray-400" />
          <rect x="-28" y="25" width="14" height="30" rx="5" className="fill-gray-500" />

          {/* Front legs */}
          <rect x="35" y="25" width="14" height="35" rx="5" className="fill-gray-500 dark:fill-gray-400" />
          <rect x="52" y="25" width="14" height="30" rx="5" className="fill-gray-500" />

          {/* Wide paws */}
          <ellipse cx="-38" cy="62" rx="10" ry="5" className="fill-gray-500 dark:fill-gray-400" />
          <ellipse cx="42" cy="62" rx="10" ry="5" className="fill-gray-500 dark:fill-gray-400" />

          {/* Head */}
          <circle cx="85" cy="-12" r="24" className="fill-gray-500 dark:fill-gray-400" />
          {/* Ears */}
          <circle cx="75" cy="-34" r="7" className="fill-gray-500 dark:fill-gray-400" />
          <circle cx="95" cy="-32" r="7" className="fill-gray-500 dark:fill-gray-400" />
          ...
          {/* Chest area — larger */}
          <ellipse cx="55" cy="5" rx="28" ry="30" className="fill-gray-500 dark:fill-gray-400" />
        </g>
        ...
        <g>
          ...
          <text x="142" y="240" textAnchor="middle" fontSize="7" className="fill-gray-500 dark:fill-gray-400">
            Insulation at -40°C
          </text>
        </g>
        ...
        <g>
          ...
          <text x="495" y="220" textAnchor="middle" fontSize="7" className="fill-gray-500 dark:fill-gray-400">
            Warm thin cold air
          </text>
        </g>
        ...
        <g>
          ...
          <text x="162" y="360" textAnchor="middle" fontSize="7" className="fill-gray-500 dark:fill-gray-400">
            Natural snowshoes
          </text>
        </g>
        ...
        <g>
          ...
          <text x="70" y="293" textAnchor="middle" fontSize="7" className="fill-gray-500 dark:fill-gray-400">
            Balance + face warmer
          </text>
        </g>
        ...
        <g>
          ...
          <text x="470" y="305" textAnchor="middle" fontSize="7" className="fill-gray-500 dark:fill-gray-400">
            Efficient breathing at altitude
          </text>
        </g>

        {/* Insight bar */}
        <rect x="40" y="388" width="520" height="22" rx="4" className="fill-gray-100 dark:fill-slate-800" />
        <text x="300" y="403" textAnchor="middle" fontSize="9" className="fill-gray-600 dark:fill-gray-300" fontWeight="600">
