export default function TotalInternalReflectionDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 583 295" className="w-full max-w-2xl mx-auto" role="img" aria-label="Total internal reflection showing three cases: below, at, and above the critical angle">
