export default function StarDistanceModulusDiagram() {
  return (
    <svg viewBox="0 0 580 331" className="w-full max-w-2xl mx-auto my-4" role="img" aria-label="Distance modulus showing apparent vs absolute magnitude and how distance affects brightness">
