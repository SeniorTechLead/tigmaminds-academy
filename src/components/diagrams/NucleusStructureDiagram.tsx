export default function NucleusStructureDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 400 340" className="w-full max-w-xl mx-auto" role="img" aria-label="Nucleus structure showing protons and neutrons held by strong nuclear force">
