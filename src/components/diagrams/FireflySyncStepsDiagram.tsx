export default function FireflySyncStepsDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox={`0 0 ${w} ${h}`} className="w-full max-w-2xl mx-auto" role="img" aria-label="Three steps of firefly synchronization: random, adjusting, and synchronized phases">
