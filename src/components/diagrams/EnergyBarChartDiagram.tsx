...
export default function EnergyBarChartDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 546 294" className="w-full max-w-2xl mx-auto" role="img" aria-label="Energy bar chart showing kinetic and potential energy of a ball rolling down a hill">
        {/* Title */}
