export default function BabelForcesDiagram() {
  return (
    <svg viewBox="0 0 520 340" className="w-full max-w-lg mx-auto">
      ...
      <text x="260" y="330" textAnchor="middle" className="fill-gray-500 dark:fill-gray-500" fontSize="11">Ground</text>

      {/* COMPRESSION — left */}
      <g>
        <rect x="40" y="160" width="60" height="130" fill="#4b5563" stroke="#9ca3af" strokeWidth="1.5" rx="3" />
        <text x="70" y="230" textAnchor="middle" className="fill-gray-900 dark:fill-white" fontSize="10" fontWeight="bold">Stone</text>
        <text x="70" y="244" textAnchor="middle" className="fill-gray-900 dark:fill-white" fontSize="10" fontWeight="bold">Column</text>
        ...
        <text x="70" y="50" textAnchor="middle" className="fill-gray-400 dark:fill-gray-400" fontSize="10">Squeezing force</text>
        <text x="70" y="63" textAnchor="middle" className="fill-gray-500 dark:fill-gray-400" fontSize="10">Stone is excellent</text>
      </g>
      ...
      <g>
        ...
        <text x="260" y="50" textAnchor="middle" className="fill-gray-400 dark:fill-gray-400" fontSize="10">Pulling-apart force</text>
        <text x="260" y="63" textAnchor="middle" className="fill-gray-500 dark:fill-gray-400" fontSize="10">Steel cables are excellent</text>
      ...
      <g>
        ...
        <rect x="410" y="175" width="70" height="25" className="fill-gray-500 dark:fill-gray-500" stroke="#9ca3af" strokeWidth="1.5" rx="2" />
        ...
        <text x="450" y="50" textAnchor="middle" className="fill-gray-400 dark:fill-gray-400" fontSize="10">Sliding force</text>
        <text x="450" y="63" textAnchor="middle" className="fill-gray-500 dark:fill-gray-400" fontSize="10">Wind on a tower</text>
      ...
      {/* Key insight */}
      <text x="260" y="285" textAnchor="middle" className="fill-gray-400 dark:fill-gray-400" fontSize="10">The Tower of Babel failed because ancient builders only understood compression.</text>
