export default function FirewalkPhysicsDiagram() {
  return (
    <div className="w-full max-w-xl mx-auto my-4">
      <svg viewBox="0 0 700 440" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto" role="img" aria-label="Three factors that make firewalking possible: low conductivity, low heat capacity, and brief contact time">
