export default function WorkForceDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 450 250" className="w-full max-w-lg mx-auto" role="img" aria-label="Work and force diagram showing a person pushing a box with force vector, displacement, and angle theta">
        {/* Ground */}
