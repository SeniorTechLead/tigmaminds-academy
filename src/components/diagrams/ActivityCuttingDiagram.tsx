  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 570 340" className="w-full max-w-lg mx-auto" role="img" aria-label="Step-by-step guide to growing a plant from a cutting">
        <rect width="570" height="340" rx="12" className="fill-slate-900" />
        ...
        {/* Step 1 */}
        <rect x="20" y="50" width="120" height="130" rx="8" className="fill-slate-800" />
        ...
        <text x="80" y="175" textAnchor="middle" className="fill-slate-400" fontSize="7">Pick a healthy stem</text>
        <text x="80" y="185" textAnchor="middle" className="fill-yellow-400" fontSize="7">with a node (bump)</text>

        {/* Step 2 */}
        <rect x="155" y="50" width="120" height="130" rx="8" className="fill-slate-800" />
        ...
        <text x="215" y="175" textAnchor="middle" className="fill-slate-400" fontSize="7">Cut at 45-degree angle</text>
        <text x="215" y="185" textAnchor="middle" className="fill-slate-400" fontSize="7">just below a node</text>

        {/* Step 3 */}
        <rect x="290" y="50" width="120" height="130" rx="8" className="fill-slate-800" />
        ...
        <text x="350" y="175" textAnchor="middle" className="fill-slate-400" fontSize="7">Node submerged</text>
        <text x="350" y="185" textAnchor="middle" className="fill-blue-300" fontSize="7">Change water daily</text>

        {/* Step 4 */}
        <rect x="425" y="50" width="125" height="130" rx="8" className="fill-slate-800" />
        ...
        <text x="487" y="185" textAnchor="middle" className="fill-slate-400" fontSize="7">Then plant in soil</text>

        {/* Best plants to try */}
        <rect x="20" y="200" width="530" height="55" rx="8" className="fill-slate-800" />
        ...
        <text x="285" y="305" textAnchor="middle" className="fill-slate-300" fontSize="9">Unlike animal cells, a plant cell at the cut node can become ANY type of cell</text>
        <text x="285" y="320" textAnchor="middle" className="fill-slate-400" fontSize="9">Root cells, leaf cells, stem cells -- all from one cutting. That is cloning in your kitchen.</text>
      </svg>
    </div>
  );
}
