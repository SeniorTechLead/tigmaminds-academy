export default function ActivityFloatTestDiagram() {
  return (
    <svg viewBox="0 0 500 260" className="w-full max-w-lg mx-auto">
      ...
      {/* Boat 1 — flat bottom */}
      <g>
        <path d="M 90 130 L 85 155 L 155 155 L 150 130 Z" className="fill-gray-400 dark:fill-gray-400" stroke="#9ca3af" strokeWidth="1.5" />
      ...
      {/* Boat 2 — V-shape */}
      <g>
        <path d="M 210 130 L 220 160 L 280 160 L 290 130 Z" className="fill-gray-400 dark:fill-gray-400" stroke="#9ca3af" strokeWidth="1.5" />
      ...
      {/* Boat 3 — round */}
      <g>
        <ellipse cx="380" cy="148" rx="40" ry="18" className="fill-gray-400 dark:fill-gray-400" stroke="#9ca3af" strokeWidth="1.5" />
      ...
      {/* Instructions */}
      <text x="250" y="55" textAnchor="middle" className="fill-gray-400 dark:fill-gray-400" fontSize="10">30cm x 30cm foil sheet → shape → float → add coins until it sinks</text>
      <text x="250" y="72" textAnchor="middle" className="fill-gray-500 dark:fill-gray-400" fontSize="9">Which hull design holds the most weight? That design displaces the most water.</text>
