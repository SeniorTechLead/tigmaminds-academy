export default function PhaseTransitionDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 400 400" className="w-full max-w-md mx-auto" role="img" aria-label="Phase transition diagram showing melting, boiling, condensation, freezing, sublimation, and deposition">
