export default function SeedDiversityDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 520 420" className="w-full max-w-2xl mx-auto" role="img" aria-label="Seed diversity comparison: monoculture versus diverse traditional farming">
