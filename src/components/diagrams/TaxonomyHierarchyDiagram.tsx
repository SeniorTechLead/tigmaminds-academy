export default function TaxonomyHierarchyDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 500 300" className="w-full max-w-lg mx-auto" role="img" aria-label="Taxonomy hierarchy from Domain to Species using tiger classification as example">
        {levels.map((level, i) => {
