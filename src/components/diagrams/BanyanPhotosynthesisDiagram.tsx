  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 570 395" className="w-full max-w-lg mx-auto" role="img" aria-label="Photosynthesis in a banyan leaf showing sunlight, CO2, and water converting to glucose and oxygen">
        <rect width="500" height="360" rx="12" className="fill-slate-900" />
        ...
        <text x="52" y="153" textAnchor="middle" className="fill-slate-200" fontSize="10" fontWeight="600">CO₂</text>
        <text x="52" y="128" textAnchor="middle" className="fill-slate-400" fontSize="9">from air</text>
        ...
        <text x="52" y="260" textAnchor="middle" className="fill-slate-400" fontSize="9">from roots</text>
        ...
        <text x="440" y="198" textAnchor="middle" className="fill-slate-400" fontSize="9">released</text>
        ...
        <text x="352" y="313" textAnchor="middle" className="fill-slate-400" fontSize="9">glucose (sugar)</text>
