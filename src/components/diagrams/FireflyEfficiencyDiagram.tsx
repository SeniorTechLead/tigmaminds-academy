export default function FireflyEfficiencyDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox={`0 0 ${w} ${h}`} className="w-full max-w-lg mx-auto" role="img" aria-label="Energy efficiency comparison: incandescent 5%, fluorescent 20%, LED 50%, firefly 98%">
