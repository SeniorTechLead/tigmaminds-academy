export default function RedoxDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 450 220" className="w-full max-w-lg mx-auto" role="img" aria-label="Redox diagram showing oxidation and reduction with electron transfer and OIL RIG mnemonic">
