export default function ArkBuoyancyDiagram() {
  return (
    <svg viewBox="0 0 500 320" className="w-full max-w-lg mx-auto">
      ...
      <g>
        <rect x="50" y="190" width="40" height="40" fill="#6b7280" stroke="#9ca3af" strokeWidth="1.5" rx="2" />
        <text x="70" y="215" textAnchor="middle" fill="white" fontSize="9" fontWeight="bold">Steel</text>
        ...
        <text x="70" y="145" textAnchor="middle" fill="#d1d5db" fontSize="10">Solid cube</text>
        <text x="70" y="158" textAnchor="middle" fill="#9ca3af" fontSize="9">7.8 g/cm³</text>
      </g>
      ...
      <g>
        ...
        <text x="250" y="180" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">Hollow hull</text>
        ...
        <text x="250" y="135" textAnchor="middle" fill="#d1d5db" fontSize="10">Same steel, hollow shape</text>
      </g>
      ...
      <g>
        ...
        <text x="410" y="145" textAnchor="middle" fill="white" fontSize="9" fontWeight="bold">Noah's Ark</text>
      ...
      <text x="250" y="50" textAnchor="middle" fill="#d1d5db" fontSize="11">Buoyant force = Weight of displaced water</text>
