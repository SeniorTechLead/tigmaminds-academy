  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 580 433" className="w-full max-w-lg mx-auto" role="img" aria-label="Dendrochronology cross-dating technique matching ring patterns across multiple trees to build a centuries-long timeline">
        ...
        <text x="250" y="44" textAnchor="middle" className="fill-gray-500 dark:fill-slate-400" fontSize="10">Matching ring patterns to build a timeline</text>

        {/* === Tree core sample A (living tree, recent) === */}
        <text x="30" y="78" className="fill-green-300" fontSize="9" fontWeight="bold">Living tree</text>
        <text x="30" y="90" className="fill-gray-500 dark:fill-slate-400" fontSize="8">felled 2024</text>
        ...
        <text x="30" y="177" className="fill-gray-500 dark:fill-slate-400" fontSize="8">from 1850s structure</text>
        ...
        <text x="30" y="264" className="fill-gray-500 dark:fill-slate-400" fontSize="8">from 1600s ruins</text>
        ...
        <text x="30" y="358" className="fill-gray-500 dark:fill-slate-400" fontSize="8">1600</text>
        <text x="140" y="358" className="fill-gray-500 dark:fill-slate-400" fontSize="8">1700</text>
        <text x="250" y="358" className="fill-gray-500 dark:fill-slate-400" fontSize="8">1800</text>
        <text x="360" y="358" className="fill-gray-500 dark:fill-slate-400" fontSize="8">1900</text>
        <text x="450" y="358" className="fill-gray-500 dark:fill-slate-400" fontSize="8">2024</text>
