export default function BodhiSeedCuttingDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 570 400" className="w-full max-w-lg mx-auto" role="img" aria-label="Seeds vs cuttings: sexual vs asexual plant reproduction">
        ...
        <text x="145" y="72" textAnchor="middle" className="fill-slate-400" fontSize="10">(Seeds)</text>
        ...
        <text x="90" y="142" textAnchor="middle" className="fill-slate-400" fontSize="9">Parent A</text>
        ...
        <text x="200" y="142" textAnchor="middle" className="fill-slate-400" fontSize="9">Parent B</text>
        ...
        <text x="145" y="218" textAnchor="middle" className="fill-slate-400" fontSize="9">DNA from both parents</text>
        ...
        <text x="145" y="330" textAnchor="middle" className="fill-slate-400" fontSize="9">Different from both parents</text>
        ...
        <text x="425" y="72" textAnchor="middle" className="fill-slate-400" fontSize="10">(Cuttings)</text>
        ...
        <text x="425" y="160" textAnchor="middle" className="fill-slate-400" fontSize="9">Parent Tree</text>
        ...
        <text x="497" y="108" textAnchor="middle" className="fill-slate-400" fontSize="8">cut</text>
        ...
        <text x="425" y="330" textAnchor="middle" className="fill-slate-400" fontSize="9">100% same DNA as parent</text>
        ...
        <text x="285" y="382" textAnchor="middle" className="fill-slate-400" fontSize="9">Planted ~288 BCE -- genetically identical to the tree under which the Buddha sat</text>
