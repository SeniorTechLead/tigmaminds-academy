export default function PhylogeneticTreeDiagram() {
  return (
    <div className="my-4">
      <svg viewBox="0 0 605 395" className="w-full max-w-2xl mx-auto" role="img" aria-label="Phylogenetic tree showing branching from common ancestor to bacteria, archaea, plants, fungi, and animals">
