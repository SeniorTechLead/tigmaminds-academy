export default function NitrogenCycleDiagram() {
  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 500 400" className="w-full max-w-lg mx-auto" role="img" aria-label="Nitrogen cycle diagram showing circular flow from atmospheric nitrogen through organisms and back">
