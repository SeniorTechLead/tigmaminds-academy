export default function StarObservatoryDiagram() {
  return (
    <svg viewBox="0 0 567 350" className="w-full max-w-2xl mx-auto my-4" role="img" aria-label="Observatory design showing dome, mount, CCD camera and why observatories are on mountaintops">
