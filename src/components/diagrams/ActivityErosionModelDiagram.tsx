  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 580 380" className="w-full max-w-2xl mx-auto" role="img" aria-label="Step-by-step instructions for building a mini river erosion model using a tray, sand, and water">
        ...
        {/* Step 1: Materials */}
        <rect x="15" y="42" width="170" height="155" rx="8" className="fill-gray-100 dark:fill-slate-800" />
        ...
        <text x="100" y="89" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="10">Baking tray</text>
        ...
        <text x="100" y="165" className="fill-gray-500 dark:fill-slate-400" fontSize="9">Small objects</text>
        <text x="100" y="178" className="fill-gray-500 dark:fill-slate-400" fontSize="9">(stones, twigs)</text>

        {/* Step 2: Build terrain */}
        <rect x="195" y="42" width="190" height="155" rx="8" className="fill-gray-100 dark:fill-slate-800" />
        ...
        <text x="290" y="168" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="10">Tilt the tray. Pile sand</text>
        <text x="290" y="181" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="10">higher at one end.</text>
        <text x="290" y="193" textAnchor="middle" className="fill-amber-400" fontSize="10">Add a mound = "island"</text>

        {/* Step 3: Pour water */}
        <rect x="395" y="42" width="170" height="155" rx="8" className="fill-gray-100 dark:fill-slate-800" />
        ...
        <text x="480" y="168" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="10">Pour slowly from</text>
        <text x="480" y="181" textAnchor="middle" className="fill-gray-600 dark:fill-slate-300" fontSize="10">the high end.</text>
        <text x="480" y="193" textAnchor="middle" className="fill-blue-400" fontSize="10">Watch the channel form!</text>

        {/* Observation prompts */}
        <rect x="15" y="207" width="550" height="165" rx="8" className="fill-gray-100 dark:fill-slate-800" />
        ...
        {[
          ...
          <g key={`obs-${i}`}>
            ...
            <text x="48" y={264 + i * 28} className="fill-gray-500 dark:fill-slate-400" fontSize="10">{a}</text>
          </g>
        ))}
      </svg>
    </div>
