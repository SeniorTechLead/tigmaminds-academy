  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 545 409" className="w-full max-w-lg mx-auto" role="img" aria-label="Biomass estimation pipeline from field measurements through allometric equations to per-hectare estimates">
        ...
        <text x="250" y="44" textAnchor="middle" className="fill-slate-400" fontSize="10">From tape measure to tonnes per hectare</text>
        ...
        <text x="85" y="120" textAnchor="middle" className="fill-slate-300" fontSize="8">DBH = 60 cm</text>
        <text x="85" y="132" textAnchor="middle" className="fill-slate-300" fontSize="8">Height = 25 m</text>
        <text x="85" y="144" textAnchor="middle" className="fill-slate-300" fontSize="8">Species: Banyan</text>
        ...
        {/* Formula */}
        <text x="250" y="105" textAnchor="middle" className="fill-slate-200" fontSize="9">B = a × DBH^b × H^c</text>
        <text x="250" y="120" textAnchor="middle" className="fill-slate-400" fontSize="8">a = 0.0509</text>
        <text x="250" y="132" textAnchor="middle" className="fill-slate-400" fontSize="8">b = 2.5, c = 0.6</text>
        ...
        <text x="415" y="144" textAnchor="middle" className="fill-slate-400" fontSize="8">single tree biomass</text>
        ...
        <rect x="100" y="178" width="300" height="70" rx="8" className="fill-slate-800" />
        ...
        <text x="250" y="312" textAnchor="middle" className="fill-slate-300" fontSize="9">Plot = 0.04 ha (20×20 m) → multiply by 25</text>
