  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 547 420" className="w-full max-w-lg mx-auto" role="img" aria-label="Allometric relationships showing log-log plots of tree diameter versus height, crown width, and biomass">
        ...
        <text x="250" y="44" textAnchor="middle" className="fill-slate-400" fontSize="10">How tree measurements scale with diameter (log-log)</text>
        ...
        {/* X axis label */}
        <text x="190" y="325" textAnchor="middle" className="fill-slate-400" fontSize="10">log(Diameter) →</text>
        {/* X ticks */}
        {[80, 130, 180, 230, 280].map((x, i) => (
          <g key={`xtick-${i}`}>
            <line x1={x} y1={298} x2={x} y2={304} className="stroke-slate-600" strokeWidth="1" />
            <text x={x} y={315} textAnchor="middle" className="fill-slate-500" fontSize="7">{[10, 30, 50, 100, 200][i]} cm</text>
          </g>
        ))}

        {/* Y axis label */}
        <text x="22" y="175" textAnchor="middle" className="fill-slate-400" fontSize="10" transform="rotate(-90, 22, 175)">log(Measurement) →</text>
        ...
        {/* Legend */}
        <rect x="350" y="60" width="135" height="90" rx="6" className="fill-slate-800" />
        <text x="360" y="78" className="fill-slate-300" fontSize="9" fontWeight="bold">Power Laws:</text>
        ...
        <text x="417" y="200" textAnchor="middle" className="fill-slate-300" fontSize="7">Doubling diameter</text>
        <text x="417" y="212" textAnchor="middle" className="fill-slate-300" fontSize="7">= ~5.6× more biomass</text>
        ...
        <text x="250" y="370" textAnchor="middle" className="fill-slate-400" fontSize="8">Measure diameter at breast height (DBH) → calculate everything else</text>
