  ...
  return (
    <div className="my-4">
      <svg viewBox="0 0 570 420" className="w-full max-w-lg mx-auto" role="img" aria-label="Grafting and tissue culture techniques for plant cloning">
        ...
        <text x="150" y="72" textAnchor="middle" className="fill-slate-400" fontSize="9">Two plants joined into one</text>
        ...
        <text x="150" y="267" textAnchor="middle" className="fill-slate-400" fontSize="7">strong roots</text>
        {/* Roots */}
        ...
        <text x="150" y="88" textAnchor="middle" className="fill-slate-400" fontSize="7">desired fruit variety</text>
        ...
        <text x="85" y="208" textAnchor="middle" className="fill-slate-400" fontSize="7">promotes healing</text>
        ...
        <text x="150" y="355" textAnchor="middle" className="fill-slate-400" fontSize="8">Roots: tough wild species</text>
        <text x="150" y="368" textAnchor="middle" className="fill-slate-400" fontSize="8">Fruit: sweet desired variety</text>
        ...
        <text x="430" y="72" textAnchor="middle" className="fill-slate-400" fontSize="9">Cloning from a few cells</text>

        {/* Step 1: Tiny tissue sample */}
        <rect x="380" y="85" width="100" height="22" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
        ...
        {/* Step 2: Sterilize */}
        <rect x="380" y="122" width="100" height="22" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
        ...
        <rect x="370" y="160" width="120" height="30" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
        ...
        {/* Step 4: Callus forms */}
        <rect x="380" y="207" width="100" height="22" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
        ...
        <rect x="370" y="245" width="120" height="30" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
        ...
        {/* Step 6: Plantlets */}
        <rect x="380" y="292" width="100" height="22" rx="4" className="fill-slate-800" stroke="#2dd4bf" strokeWidth="0.5" />
