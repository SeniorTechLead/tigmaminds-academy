...
export default function SeedTravelLevel4() {
...
`);
    ...
    const miniLessons = [
    {
      title: "Capstone — Build a Seed Dispersal Simulator",
      concept: "This lesson explores aerodynamic trajectories, dispersal kernels, range expansion modeling, and landscape connectivity analysis. You will learn the mathematical foundations, build computational models, and visualize the key relationships.",
      analogy: "Think of aerodynamic trajectories, dispersal kernels, range expansion modeling, and landscape connectivity analysis as a system with inputs, processes, and outputs — your code models each step.",
      storyConnection: "The seed dispersal simulator predicts which seeds can cross rivers, which get trapped in valleys, and which ride monsoon winds across mountains.",
      checkQuestion: "Given the concepts of aerodynamic trajectories, dispersal kernels, range expansion modeling, and landscape connectivity analysis, describe how you would apply them to analyze real-world data.",
      ...
      codeIntro: "Model and visualize aerodynamic trajectories, dispersal kernels, range expansion modeling, and landscape connectivity analysis using Python.",
      ...
      successHint: "You have built a computational model of aerodynamic trajectories, dispersal kernels, range expansion modeling, and landscape connectivity analysis — connecting theory to practice through code.",
    },
  ];
