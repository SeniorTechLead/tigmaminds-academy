...
export default function TakinFaceLevel4() {
...
`);
    ...
    const miniLessons = [
    {
      title: "Capstone — Build a Population Genetics Simulator",
      concept: "This lesson explores HWE testing, drift simulation, selection modeling, inbreeding tracking, and population viability analysis for conservation management. You will learn the mathematical foundations, build computational models, and visualize the key relationships.",
      analogy: "Think of HWE testing, drift simulation, selection modeling, inbreeding tracking, and population viability analysis for conservation management as a system with inputs, processes, and outputs — your code models each step.",
      storyConnection: "The population genetics simulator integrates all evolutionary forces to predict the takin's genetic future and recommend conservation strategies.",
      checkQuestion: "Given the concepts of HWE testing, drift simulation, selection modeling, inbreeding tracking, and population viability analysis for conservation management, describe how you would apply them to analyze real-world data.",
      ...
      codeIntro: "Model and visualize HWE testing, drift simulation, selection modeling, inbreeding tracking, and population viability analysis for conservation management using Python.",
      ...
      successHint: "You have built a computational model of HWE testing, drift simulation, selection modeling, inbreeding tracking, and population viability analysis for conservation management — connecting theory to practice through code.",
    },
  ];
