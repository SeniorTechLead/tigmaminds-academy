...
export default function TalkingParrotLevel4() {
...
`);
    ...
    const miniLessons = [
    {
      title: "Capstone — Build a Bird Call Syntax Analyzer",
      concept: "This lesson explores Markov chains, information entropy, chi-squared testing, and dialect detection for analyzing bird call sequences. You will learn the mathematical foundations, build computational models, and visualize the key relationships.",
      analogy: "Think of Markov chains, information entropy, chi-squared testing, and dialect detection for analyzing bird call sequences as a system with inputs, processes, and outputs — your code models each step.",
      storyConnection: "The talking parrot analyzer discovers hidden grammatical rules in bird vocalizations.",
      checkQuestion: "Given the concepts of Markov chains, information entropy, chi-squared testing, and dialect detection for analyzing bird call sequences, describe how you would apply them to analyze real-world data.",
      ...
      codeIntro: "Model and visualize Markov chains, information entropy, chi-squared testing, and dialect detection for analyzing bird call sequences using Python.",
      ...
      successHint: "You have built a computational model of Markov chains, information entropy, chi-squared testing, and dialect detection for analyzing bird call sequences — connecting theory to practice through code.",
    },
  ];
