...
export default function GuwahatiNameLevel4() {
  const { pyodideRef, load: loadPyodide, ready: pyReady, state: pyState, loadProgress } = usePyodide();
  const loading = pyState === 'loading';

    const miniLessons = [
    {
      title: "Capstone — Build a Language Similarity Analyzer",
      concept: "This lesson explores typological features, distance metrics, PCA projection, and hierarchical clustering of NE Indian languages. You will learn the mathematical foundations, build computational models, and visualize the key relationships.",
      analogy: "Think of typological features, distance metrics, PCA projection, and hierarchical clustering of NE Indian languages as a system with inputs, processes, and outputs — your code models each step.",
      storyConnection: "Guwahati sits at the crossroads of Indo-Aryan, Tibeto-Burman, and Austro-Asiatic languages — your analyzer maps this diversity.",
      checkQuestion: "Given the concepts of typological features, distance metrics, PCA projection, and hierarchical clustering of NE Indian languages, describe how you would apply them to analyze real-world data.",
      ...
      codeIntro: "Model and visualize typological features, distance metrics, PCA projection, and hierarchical clustering of NE Indian languages using Python.",
      ...
      successHint: "You have built a computational model of typological features, distance metrics, PCA projection, and hierarchical clustering of NE Indian languages — connecting theory to practice through code.",
    },
  ];
