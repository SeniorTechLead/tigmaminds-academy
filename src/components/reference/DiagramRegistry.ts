...
const lazyMap: Record<string, () => Promise<{ default: ComponentType<any> }>> = {
  ...
  ArrangingTeacupsScene: () => import('../diagrams/ArrangingTeacupsScene'),
  CoinDiceIndependentScene: () => import('../diagrams/CoinDiceIndependentScene'),
  MedicalTestConditionalScene: () => import('../diagrams/MedicalTestConditionalScene'),
  LotteryExpectedValueScene: () => import('../diagrams/LotteryExpectedValueScene'),
  HillSlopeDerivativeScene: () => import('../diagrams/HillSlopeDerivativeScene'),
  PowerRuleScene: () => import('../diagrams/PowerRuleScene'),
  AreaUnderCurveScene: () => import('../diagrams/AreaUnderCurveScene'),
  FundamentalTheoremScene: () => import('../diagrams/FundamentalTheoremScene'),
  VectorOperationsScene: () => import('../diagrams/VectorOperationsScene'),
  MatrixSpreadsheetScene: () => import('../diagrams/MatrixSpreadsheetScene'),
  RotationMatrixScene: () => import('../diagrams/RotationMatrixScene'),
  FrequencyScene: () => import('../diagrams/FrequencyScene'),
  AmplitudeScene: () => import('../diagrams/AmplitudeScene'),
  PhaseShiftScene: () => import('../diagrams/PhaseShiftScene'),
  HarmonicsScene: () => import('../diagrams/HarmonicsScene'),
  BeatsScene: () => import('../diagrams/BeatsScene'),
  SineAnatomyScene: () => import('../diagrams/SineAnatomyScene'),
  ...
  TreasureMapCoordinateDiagram: () => import('../diagrams/TreasureMapCoordinateDiagram'),
  TeaPriceLineDiagram: () => import('../diagrams/TeaPriceLineDiagram'),
  AngleProtractorDiagram: () => import('../diagrams/AngleProtractorDiagram'),
  LadderPythagorasDiagram: () => import('../diagrams/LadderPythagorasDiagram'),
  CircleVocabularyDiagram: () => import('../diagrams/CircleVocabularyDiagram'),
  WaterDrumVolumeDiagram: () => import('../diagrams/WaterDrumVolumeDiagram'),
  JapiRotationDiagram: () => import('../diagrams/JapiRotationDiagram'),
  CityMapDistanceDiagram: () => import('../diagrams/CityMapDistanceDiagram'),
  BridgeMidpointDiagram: () => import('../diagrams/BridgeMidpointDiagram'),
  TwoLinesIntersectDiagram: () => import('../diagrams/TwoLinesIntersectDiagram'),
  PlanetOrbitsDiagram: () => import('../diagrams/PlanetOrbitsDiagram'),
  TaraSunflowerDiagram: () => import('../diagrams/TaraSunflowerDiagram'),
  PetalCountingDiagram: () => import('../diagrams/PetalCountingDiagram'),
  GoldenSpiralDrawingDiagram: () => import('../diagrams/GoldenSpiralDrawingDiagram'),
  HoneycombHexagonDiagram: () => import('../diagrams/HoneycombHexagonDiagram'),
  FernFractalDiagram: () => import('../diagrams/FernFractalDiagram'),
  ButterflySymmetryDiagram: () => import('../diagrams/ButterflySymmetryDiagram'),
  PithaRatioDiagram: () => import('../diagrams/PithaRatioDiagram'),
  ScalingRecipeDiagram: () => import('../diagrams/ScalingRecipeDiagram'),
  TeaShopGSTDiagram: () => import('../diagrams/TeaShopGSTDiagram'),
  TeaBlendingDiagram: () => import('../diagrams/TeaBlendingDiagram'),
  SharingChocolatesDiagram: () => import('../diagrams/SharingChocolatesDiagram'),
  PrimeAtomsDiagram: () => import('../diagrams/PrimeAtomsDiagram'),
  TwoBusesLCMDiagram: () => import('../diagrams/TwoBusesLCMDiagram'),
  GaussSumDiagram: () => import('../diagrams/GaussSumDiagram'),
  ClockArithmeticDiagram: () => import('../diagrams/ClockArithmeticDiagram'),
  ...
  MerryGoRoundUnitCircleDiagram: () => import('../diagrams/MerryGoRoundUnitCircleDiagram'),
  ...
  RiverWidthDiagram: () => import('../diagrams/RiverWidthDiagram'),
  TwoObservationDiagram: () => import('../diagrams/TwoObservationDiagram'),
  ...
  FerrisWheelSineDiagram: () => import('../diagrams/FerrisWheelSineDiagram'),
  ...
  AreaUnderCurveDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.AreaUnderCurve })),
  ...
  ImmuneSystemDiagram: () => import('../diagrams/ImmuneSystemDiagram'),
  ...
  AngleExplorerDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.AngleExplorer })),
  TriangleExplorerDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.TriangleExplorer })),
  ProbabilityDiceDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.ProbabilityDice })),
  GaussianExplorerDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.GaussianExplorer })),
  DerivativeVisualizerDiagram: () => import('../diagrams/MathInteractiveDiagrams').then(m => ({ default: m.DerivativeVisualizer })),
  ...
  GitStagingDiagram: () => import('../diagrams/GitStagingDiagram'),
  APIRequestFlowDiagram: () => import('../diagrams/APIRequestFlowDiagram'),
  RESTMethodsDiagram: () => import('../diagrams/RESTMethodsDiagram'),
  TypeCheckerDiagram: () => import('../diagrams/TypeCheckerDiagram'),
  UnionNarrowingDiagram: () => import('../diagrams/UnionNarrowingDiagram'),
  NullSafetyDiagram: () => import('../diagrams/NullSafetyDiagram'),
  GenericsDiagram: () => import('../diagrams/GenericsDiagram'),
