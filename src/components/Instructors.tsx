...
export default function Instructors() {
  ...
  if (loading) {
    return (
      <section id="instructors" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-sm sm:text-base text-gray-600 dark:text-gray-300">Loading instructors...</div>
        </div>
      </section>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4">
            ...
            <span className="text-xs sm:text-sm font-semibold">Expert Instructors</span>
          </div>
            ...
            <div key={instructor.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300 group">
              ...
              <div className="p-4 sm:p-6">
                ...
                {instructor.linkedin_url && (
                  <button className="flex items-center gap-1.5 sm:gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
        ...
        <div className="mt-12 text-center">
          ...
          >
            <span className="text-lg font-semibold">View All Instructors</span>
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
            Meet all our expert instructors and discover their specializations
          </p>
        </div>
      </div>
    </section>
