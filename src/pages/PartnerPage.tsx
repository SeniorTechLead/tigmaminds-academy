    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-amber-500 to-orange-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to="/lessons" className="inline-flex items-center bg-white text-amber-600 px-8 py-3 rounded-full font-semibold hover:shadow-xl hover:scale-105 transition-all">
