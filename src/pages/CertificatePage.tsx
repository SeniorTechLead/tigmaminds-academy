        ...
        <div className="max-w-4xl mx-auto">
          ...
          {totalCompleted === 0 ? (
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 text-center">
              ...
              <Link to="/lessons" className="inline-flex items-center gap-2 bg-amber-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-amber-600 transition-colors">
                Start Learning
              </Link>
            </div>
          ) : (
