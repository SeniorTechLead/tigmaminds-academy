  ...
  problems: [
    ...
    },
    {
      ...
      steps: [
        ...
        { label: 'Step 3: Variance of Z²', content: 'Var(Z²) = E[Z⁴] − (E[Z²])². For standard normal, E[Z⁴] = 3 (the 4th moment). So Var(Z²) = 3 − 1 = **2**' },
        { label: 'Step 4: Variance of χ²₅', content: 'Since the Zᵢ are independent: Var(χ²₅) = Var(Z₁²) + ... + Var(Z₅²) = 2 + 2 + 2 + 2 + 2 = **10**' },
        { label: 'General rule', content: 'For χ²ₖ: **Mean = k, Variance = 2k**. Each extra degree of freedom adds 1 to the mean and 2 to the variance.' },
      ],
